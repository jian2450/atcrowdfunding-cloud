 ...
 <div class="navbar-wrapper">
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="col-xs-6 col-md-3">
      	<h2>商业公司</h2>
        <a href="javascript:;" accttype="0" class="thumbnail">
